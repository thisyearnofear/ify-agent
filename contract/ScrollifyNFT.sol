...
/**
 * @title ScrollifyNFT
 * @dev ERC721 contract for minting NFTs from images created with the "scrollify" overlay
 */
contract ScrollifyNFT is ERC721URIStorage, Ownable {
    ...
    // Events
    event ScrollifyNFTMinted(uint256 indexed tokenId, address indexed creator, string groveUrl, string tokenURI);
    
    constructor() ERC721("Scrollify Collection", "SCROLL") Ownable(msg.sender) {}
    ...
    /**
     * @dev Mints a new NFT for a scrollify image
    ...
    function mintNFT(
        ...
        emit ScrollifyNFTMinted(newTokenId, creator, groveUrl, tokenURI);
